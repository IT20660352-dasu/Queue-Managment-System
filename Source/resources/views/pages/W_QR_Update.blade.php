...
@section('subhead')
    <title>Update WhatsApp QR Code</title>
@endsection
@section('subcontent')
@if($errors->any())
@endif
 ...
 <div >
    ...
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Preview of WhatsApp QR Code</h2>
    </div>
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 lg:col-span-3">
            <div class="intro-y box p-5">
                <img src="{{ asset('QR/' . $Branch->W_QR) }}" height="500" wight="500"class="card-img-top"
                                alt="QR images">
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 lg:col-span-3">
            ...
            <form action="{{ route('storeEdt_WQR',$Branch->id) }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
            ...
            <div class="intro-y box p-5">
                     ...
                     <div>
                        <label for="crud-form-1" class="form-label"> UPDATE WHATSAPP QR</label>

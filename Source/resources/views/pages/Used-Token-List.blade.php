        ...
        <div class="intro-y col-span-12 flex flex-wrap xl:flex-nowrap items-center mt-2">
            <div class="flex w-full sm:w-auto">
                <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                    <form method="get" action="{{ route('Used-Token-List') }}">
                ...
                <tbody>
                    @foreach ($data as $Token)
                        <tr class="intro-x">
                            ...
                            {{-- <td class="text-center">
                                <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5"> {{ $Token['patient_id'] }}</div>
                            </td> --}}
                            {{-- <td class="text-center">
                                <div class="text-slate-500 text-xs whitespace-nowrap mt-0.5"> {{ $Token->getPatient['phone_number'] }}</div>
                            </td> --}}
                            <td>
    ...
    $(document).ready(function () {
        ...
        $('body').on('click', '#show-user', function () {
          ...
          $.get(userURL, function (data) {
              ...
              $('#Patients-full_name').text(data.full_name);
              $('#Patients-phone_number').text(data.phone_number);
              $('#Patients-age').text(data.age);
          })
       });

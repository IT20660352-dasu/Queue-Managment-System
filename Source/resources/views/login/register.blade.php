        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                ...
                <div class="my-auto">
                    ...
                    <div class="-intro-x text-white font-medium text-4xl leading-tight mt-10"><br> Register to your account.
                    </div>
                ...
                <div
                    ...
                    <form method="POST" action="{{ route('RegisterUser') }}" enctype="multipart/form-data">
                        ...
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                            <a href="{{ url('/login') }}"><button type="button" class="btn btn-outline-secondary w-24 mr-1">LOGIN</button>
                            </a>
